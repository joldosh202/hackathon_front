  ...
  return (
   ...
   <MenuList>
    ...
    Транзакции
      ...
      <Button h='55px' bg='#EBBB55' w={isSmallerThan800 ? '300px' : '637px'} onClick={registerBtn}>Далее</Button>
    
        <Box mt='40px' >

        {/* <Link  to="/verify">
        <Button h='55px' bg='#EBBB55' w={isSmallerThan800 ? '300px' : '637px'}>
          Потвердить пользователя
        </Button>
        </Link> */}
        </Box>
        </Box>
